...
# Answer 2: Yes, it is skewed. We can see it by looking
# at the hist plot, because there are so much more values closer than the 'lower part'
# (5 - 15) than the upper part, with greater values
